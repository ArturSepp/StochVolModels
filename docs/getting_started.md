...
On the reference Windows/Python 3.12 run, version 2.1.0 produced vanilla price `0.197331`, vanilla
implied volatility `0.999577`, and six-month at-the-money price/volatility `0.275202`/`0.995757` in
13.15 seconds. Values are deterministic; elapsed time is machine-dependent. The first process pays
