...
from svm.pricers.model_pricer import ModelPricer, ModelParams
import svm.pricers.logsv.affine_expansion as afe
from svm.pricers.logsv.affine_expansion import ExpansionOrder
from svm.pricers.core.mc_payoffs import compute_mc_vars_payoff
from svm.data.option_chain import OptionChain
from svm.data.test_option_chain import get_btc_test_chain_data
from svm.utils.funcs import to_flat_np_array, set_time_grid, timer, compute_histogram_data
...
class LogSvParams(ModelParams):
    """
    implementation of model params
    """
    sigma0: float = 0.2
    theta: float = 0.2
    kappa1: float = 1.0
