...
def get_vix_test_chain_data() -> ChainData:
    """
...
def get_gld_test_chain_data() -> ChainData:
    """
...
def get_sqqq_test_chain_data() -> ChainData:
    """
...
def get_spy_test_chain_data() -> ChainData:
    """
...
def run_unit_test(unit_test: UnitTests):
    ...
    if unit_test == UnitTests.BTC:
        ...
        chain_data = get_vix_test_chain_data()
        print(chain_data)

    elif unit_test == UnitTests.GLD:
        chain_data = get_gld_test_chain_data()
        print(chain_data)

    elif unit_test == UnitTests.SQQQ:
        chain_data = get_sqqq_test_chain_data()
        print(chain_data)

    elif unit_test == UnitTests.SPY:
        chain_data = get_spy_test_chain_data()
        print(chain_data)
