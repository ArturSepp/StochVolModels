"""
value payoffs under the quadratic pricing kernel and imply BSM vols
"""
...
if __name__ == '__main__':
    ...
    run_unit_test(unit_test=UnitTests.Q_KERNEL_VALUATION)
